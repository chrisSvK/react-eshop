  ...
  return (
    <div>
      <img
        ...
        src={require("../img/homeLayout.jpg")}
      />
      <div className="scroll-downs">
        <div className="mousey">
          <div className="scroller">
            <div id={"scrollerText"}>Scroll down</div>
          </div>
        </div>
      </div>
      <h1
              ...
              {favLoading ? (
                ...
                <>
                  {favProducts.map((product) => (
                    <Link to={ROUTES.PRODUKT + "/" + product.produktId}>
                      <Card>
                        <Card.Img
                          variant="top"
                          src={require("../img/products/" +
                            product.galeria[0].name)}
                        />
                        <Card.Body>
